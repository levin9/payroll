        ...
        <div class="crumbs">
            <div style="width:50%; bgcolor:red;" >
                <el-breadcrumb separator="/">
                            ...
                            <el-breadcrumb-item> 考勤项维护</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
        ...
        <div class="container" >
          <el-form ref="form" :rules="rules" :model="formModel" label-width="100px">
            <div style="margin-top:-20px;">
               <el-row>
                    <el-col :span="8">
                      <el-form-item label="薪资项名称" prop="tenant_holiday_name" required=“true” ><el-input v-model="formModel.tenant_holiday_name" ></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="1"> &nbsp; </el-col>    
                    <el-col :span="8">                        
                        <el-form-item label="项目类别" prop="ItemType" required=“true” >
                            <el-select  placeholder="请选择" v-model="formModel.ItemType"  width="100%" >
                                <el-option
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="启用" prop="is_used"  >
                            <el-switch               
                                    :active-value=1   :inactive-value=2
                                    on-color="#5B7BFA"  off-color="#dadde5"
                                    v-model="formModel.is_used"  >
                            </el-switch>
                            {{formModel.f_sort_code}}
                        </el-form-item>
                    </el-col>
                    <el-col :span="1"> &nbsp; </el-col>    
                    <el-col :span="8">
                        <el-form-item label="序号" prop="f_sort_code" required=“true” >
                            <el-input-number type="number" v-model="formModel.f_sort_code" :min="1" :max="100" ></el-input-number>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
...
import bottomBar from    '../../components/common/BottomBar.vue'
  ...
  export default {
    ...
    mounted(){  
        this.$fetch('attcategorytenant/' + this.$route.query.id )
        .then((response) => {
            //alert(this.response.data.is_used);     
       ...
       handleSave(formData){
            this.$refs['form'].validate((valid) => {
                if (!valid) {
                    ...
                    this.$patch('attcategorytenant',this.formModel)
                    .then((response) => {
                    ...
                    this.$router.push({path:'/companyedit',query: {active_tab_name:"attset"}});
                    this.$destroy(true);           
                }
            });
       },
