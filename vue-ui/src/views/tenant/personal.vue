    ...
    <div>
        ...
        <div class="container">
            ...
            >
               ...
               <!-- <el-table-column prop="job_no" label="工号"></el-table-column> -->
               <el-table-column prop="job_name" label="岗位"></el-table-column>
               <!-- <el-table-column prop="job_level" label="职级"></el-table-column> -->

                <!-- <el-table-column label="姓名">
                    <template slot-scope="real_name">￥{{scope.row.money}}</template>
                </el-table-column> -->
                ...
                <el-table-column prop="join_date" label="入职日期" align="center" :formatter="dateFormat"></el-table-column>
                <el-table-column label="状态" align="center">
                    <template slot-scope="scope">
                        <el-tag
                            :type="scope.row.last_date===undefined ?'success':'info'"
                        >{{scope.row.last_date ===undefined?'在职':'离职' }}</el-tag>
                    </template>
                </el-table-column>          
...
export default {
    ...
    methods: {
         ...
         getData() { 
            this.$fetch('personal',this.query )
            .then((response) => {
