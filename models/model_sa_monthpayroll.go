...
type Monthpayroll struct {
	...
	Workday   int     `gorm:"column:WorkDay" form:"work_day" json:"work_day" comment:"工作天数" sql:"int(10)"`
	Planworkday   int     `gorm:"column:PlanWorkDay" form:"plan_work_day" json:"plan_work_day" comment:"应上班天数" sql:"int(11)"`
	Actualworkday   int     `gorm:"column:ActualWorkDay" form:"actual_work_day" json:"actual_work_day" comment:"实际出勤天数" sql:"int(11)"`
	...
	Chidaocount   int     `gorm:"column:ChiDaoCount" form:"chi_dao_count" json:"chi_dao_count" comment:"迟到次数" sql:"int(10)"`
	Chidaofee   float32     `gorm:"column:ChiDaoFee" form:"chi_dao_fee" json:"chi_dao_fee" comment:"迟到扣款" sql:"decimal(10,4)"`
	Zaotuicount   int     `gorm:"column:ZaotuiCount" form:"zaotui_count" json:"zaotui_count" comment:"早退次数" sql:"int(10)"`
